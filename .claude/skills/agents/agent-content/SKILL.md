...
1. **Social Media Posts** -- Draft posts for LinkedIn, X/Twitter, or other platforms. Tone: informative and professional.
2. **Blog Articles** -- Write articles that showcase OphidianAI's expertise in web design and AI.
3. **Website Copy** -- Write or refine copy for OphidianAI's own website.
4. **Case Studies** -- Turn completed client projects into case studies that demonstrate results.
5. **Email Newsletters** -- Draft email content for nurturing leads or updating clients.
...
- "Create website copy for our services page"
- "Draft a newsletter about [update]"
...
- **LinkedIn:** Professional, longer-form okay. Lead with insight, not promotion.
- **X/Twitter:** Short, punchy, opinionated. One idea per post.
