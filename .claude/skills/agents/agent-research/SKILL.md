...
- "What tools are available for [use case]?"
- "What AI trends matter for small business clients?"
- "Find me new MCP servers or plugins I should try"
- "What's the latest on [specific AI topic]?"

## Research Process

1. **Search** -- Use Perplexity for AI-powered research queries. It provides sourced, up-to-date answers with citations.
...
- **Perplexity** -- Primary tool for all research. Use for AI-powered search with sourced, cited answers. Ideal for tracking industry news, model releases, pricing changes, and competitive intelligence.
- **Firecrawl** -- Use as a fallback for reading specific URLs, documentation pages, or scraping sites that need deeper extraction.
