...
| 4. Mockup         | Generate a pitch website mockup using the prospect-mockup skill. Uses real business content, industry-appropriate design, and saves to prospect folder with screenshots.                               | prospect-mockup skill, Firecrawl, Playwright            |
